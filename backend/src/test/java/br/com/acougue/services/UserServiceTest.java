...
class UserServiceTest {
    ...
    void registerUser_shouldRegisterSuccessfully_whenDataIsValid() {
        ...
        when(userMapper.toEntityFromRegisterDTO(userRegisterDTO)).thenReturn(newUser);
        ...
        assertEquals(establishment, newUser.getEstablishment());
        assertEquals(Role.ROLE_EMPLOYEE, newUser.getRole());
    }
